<template>
  ...
  >
    <template slot="title">
      ...
      <a-button style="float:right;margin-right:10px;" @click="openExternal('https://gitee.com/wangliang181230/dev-sidecar/blob/master/doc/caroot.md')">为什么要安装证书？</a-button>
    </template>
    <div>
